...
-- Run in SQL Editor AFTER 005_product_detail.sql.
-- Idempotent (re-runnable).
--
-- Photo mapping:
--   image      = the burlap-sack photo (also used as the card thumbnail)
--   detail_img = the label-package photo (second photo in the modal)
...
set
  image          = 'assets/products-detail/아라비카_아체가요_내추럴_3.png',
  detail_img     = 'assets/products-detail/아라비카_아체가요_내추럴_2.png',
...
update product_items
set
  image          = 'assets/products-detail/아라비카_아체가요_풀워시드_3.png',
  detail_img     = 'assets/products-detail/아라비카_아체가요_풀워시드_2.png',
...
update product_items
set
  image          = 'assets/products-detail/아라비카_아체가요_세미워시드_3.png',
  detail_img     = 'assets/products-detail/아라비카_아체가요_세미워시드_2.png',
